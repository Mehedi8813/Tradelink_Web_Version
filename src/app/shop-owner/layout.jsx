...
import { LogOut, Package, LayoutDashboard, Store, Settings, ShoppingCart } from "lucide-react";
    ...
    <div className="flex h-screen bg-slate-50">
      <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col shadow-xl">
        ...
        <nav className="flex-1 px-4 mt-6 space-y-1">
          ...
          <Link
            href="/shop-owner/dashboard/products"
            className={`flex items-center gap-3 px-4 py-2.5 rounded-lg font-medium transition-colors ${
              pathname === "/shop-owner/dashboard/products"
                ? "bg-emerald-500/10 text-emerald-400"
                : "hover:bg-white/5 hover:text-white"
            }`}
          >
          ...
          <Link
            href="/shop-owner/dashboard/orders"
            className={`flex items-center gap-3 px-4 py-2.5 rounded-lg font-medium transition-colors ${
              pathname === "/shop-owner/dashboard/orders"
                ? "bg-emerald-500/10 text-emerald-400"
                : "hover:bg-white/5 hover:text-white"
            }`}
          >
          ...
          <Link
            href="/shop-owner/dashboard/settings"
            className={`flex items-center gap-3 px-4 py-2.5 rounded-lg font-medium transition-colors ${
              pathname === "/shop-owner/dashboard/settings"
                ? "bg-emerald-500/10 text-emerald-400"
                : "hover:bg-white/5 hover:text-white"
            }`}
          >
