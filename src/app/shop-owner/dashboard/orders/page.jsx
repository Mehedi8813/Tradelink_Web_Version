      ...
      <body>
        <div class="slip">
          ...
          <div class="footer">
            ...
            <p style="margin-top: 4px;">Generated by TradeLink Shop Owner Portal</p>
          </div>
        </div>
      </body>
      </html>
  ...
  return (
    <>
      ...
      <div className="p-8 bg-gradient-to-br from-slate-50 via-slate-50 to-emerald-50/30 min-h-screen font-sans">
        ...
        >
          <div>
            <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Buying Details & Orders</h1>
            <p className="mt-1.5 text-sm text-slate-500 font-medium">Track your bulk purchases and active logistics.</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
            <p className="text-xs font-bold text-emerald-500 uppercase tracking-wide">Total Spend</p>
